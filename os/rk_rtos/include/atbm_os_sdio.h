...
#define __atbm_sdio_memcpy_fromio  sdio_memcpy_fromio
#define __atbm_sdio_memcpy_toio  sdio_memcpy_toio
#define atbm_sdio_claim_irq  sdio_claim_irq
#define atbm_sdio_release_irq  sdio_release_irq
#define atbm_sdio_device_id  sdio_device_id
#define atbm_sdio_func  sdio_func
#define atbm_sdio_get_drvdata  sdio_get_drvdata
#define atbm_sdio_f0_readb  sdio_f0_readb
#define atbm_sdio_f0_writeb  sdio_f0_writeb
