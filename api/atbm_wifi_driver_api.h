...
atbm_void wifi_ConnectAP_vif(struct atbmwifi_vif *priv,atbm_uint8 * ssid,int ssidlen,atbm_uint8 * password,
		int passwdlen,ATBM_SECURITY_TYPE key_mgmt);
atbm_void wifi_StartAP_vif(struct atbmwifi_vif *priv,atbm_uint8 * ssid,int ssidlen,atbm_uint8 * password,
...
#else
atbm_void atbm_wifi_tx_pkt(ATBM_NETIF *netif, atbm_void *p);
#endif
...
******************************************************************************/
#ifndef ATBM_COMB_IF 
atbm_int32 atbm_wifi_sta_join_ap(char *ssid, char *bssid, int authMode, int encryption, const char *key);
#else
atbm_int32 atbm_wifi_sta_join_ap(atbm_uint8 if_id,char *ssid, char *bssid, int authMode, int encryption, const char *key);
#endif
...
atbm_int32 wifi_get_associated_client_list(atbm_uint8 *pchBuf, atbm_uint32 uiBufSize);
...
atbm_int32 atbm_wifi_wps_start_pbc(atbm_uint8 *p2p_info);
