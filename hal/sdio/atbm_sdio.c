...
#elif (PLATFORM==JIANRONG_RTOS_3298)
#include "sdcard.h"
#elif (PLATFORM==AK_RTOS_300) || (PLATFORM==AK_RTOS_37D)
#include "interrupt.h"
#endif
...
#if(PLATFORM==JIANRONG_RTOS_3298)
...
#elif (PLATFORM==JIANRONG_RTOS_3268)
...
static int atbm_sdio_reset(struct sbus_priv *self)
{
	...
	/**********************/
set_func0_err:
	atbm_sdio_set_block_size(self->func,ATBM_SDIO_BLOCK_SIZE);
