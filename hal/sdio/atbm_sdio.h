...
#define ATBM_HIFREG_CONFIG_CPU_RESET_BIT_2	(BIT(22))
 ...
 int atbm_reg_write(struct atbmwifi_common *hw_priv, atbm_uint16 addr,
			  const atbm_void *buf, atbm_uint32 buf_len);
 static  int atbm_reg_read_8(struct atbmwifi_common *hw_priv,
					  atbm_uint16 addr, atbm_uint8 *val)
 {
	 atbm_uint32 bigVal;
	 int ret;
	 ret = atbm_reg_read_dpll(hw_priv, addr, &bigVal, sizeof(bigVal));
 //  wifi_printk(WIFI_IF, "%x,bigVal,func=%s\n",bigVal,__FUNCTION__);
	 *val = (atbm_uint8)bigVal;
	 return ret;
 }
 static  int atbm_reg_write_8(struct atbmwifi_common *hw_priv,
					   atbm_uint16 addr, atbm_uint8 val)
 {
	 atbm_uint32 bigVal = (atbm_uint32)val;
 //  wifi_printk(WIFI_IF, "%x,val,func=%s\n",val,__FUNCTION__);
	 return atbm_reg_write_dpll(hw_priv, addr, &bigVal, sizeof(bigVal));
 }
 static  int atbm_reg_read_16(struct atbmwifi_common *hw_priv,
 ...
 static  int atbm_reg_write_16(struct atbmwifi_common *hw_priv,
					   atbm_uint16 addr, atbm_uint16 val)
 {
	 atbm_uint32 bigVal = (atbm_uint32)val;
	 return atbm_reg_write(hw_priv, addr, &bigVal, sizeof(bigVal));
 }
 static  int atbm_reg_read_32(struct atbmwifi_common *hw_priv,
					  atbm_uint16 addr, atbm_uint32 *val)
 {
	 return atbm_reg_read(hw_priv, addr, val, sizeof(int));
 }
 static  int atbm_reg_write_32(struct atbmwifi_common *hw_priv,
					   atbm_uint16 addr, atbm_uint32 val)
 {
...
static  int atbm_ahb_write_32(struct atbmwifi_common *hw_priv,
				   atbm_uint32 addr, atbm_uint32 val)
{
