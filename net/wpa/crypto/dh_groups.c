...
FLASH_FUNC const struct dh_group * dh_groups_get(int id)
{
	size_t i;
 ...
 */
FLASH_FUNC struct wpabuf * dh_init(const struct dh_group *dh, struct wpabuf **priv)
{
	struct wpabuf *pv;
	atbm_size_t pv_len;
 ...
 */
FLASH_FUNC struct wpabuf * dh_derive_shared(const struct wpabuf *peer_public,
