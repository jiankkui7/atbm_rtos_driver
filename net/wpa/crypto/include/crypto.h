...
/**
 * atbm_sha1_vector - SHA-1 hash for data vector
 * @num_elem: Number of elements in the data vector
 * @addr: Pointers to the data areas
 * @len: Lengths of the data blocks
 * @mac: Buffer for the hash
 * Returns: 0 on success, -1 on failure
 */
int atbm_sha1_vector(atbm_size_t num_elem, const atbm_uint8 *addr[], const atbm_size_t *len,
		atbm_uint8 *mac);
 ...
 * Returns: 0 on success, -1 on failure
 */
int sha256_vector(atbm_size_t num_elem, const atbm_uint8 *addr[], const atbm_size_t *len,
		  atbm_uint8 *mac);
 ...
 */
void * aes_encrypt_init(const atbm_uint8 *key, atbm_size_t len);
 ...
 */
void aes_encrypt(void *ctx, const atbm_uint8 *plain, atbm_uint8 *crypt);
 ...
 * Returns: Pointer to context data or %NULL on failure
 */
void * aes_decrypt_init(const atbm_uint8 *key, atbm_size_t len);
 ...
 */
void aes_decrypt(void *ctx, const atbm_uint8 *crypt, atbm_uint8 *plain);
