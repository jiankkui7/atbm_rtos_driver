...
int p2p_parse_ies(const atbm_uint8 *data, size_t len, struct p2p_message *msg);
int p2p_parse(const atbm_uint8 *data, size_t len, struct p2p_message *msg);
int p2p_parse_ies_separate(const atbm_uint8 *wsc, size_t wsc_len, const atbm_uint8 *p2p,
...
int p2p_group_info_parse(const atbm_uint8 *gi, size_t gi_len,
...
void p2p_rx_gas_initial_req(struct p2p_data *p2p, const atbm_uint8 *sa,
			    const atbm_uint8 *data, size_t len, int rx_freq);
...
int p2p_peer_channels_check(struct p2p_data *p2p, struct p2p_channels *own,
			    struct p2p_device *dev,
			    const atbm_uint8 *channel_list, size_t channel_list_len);
