...
FLASH_FUNC atbm_int32 wps_build_public_key(struct wps_data *wps, struct wpabuf *msg)
{
	...
	//wps->dh_privkey = NULL;
	//wpa_printf(MSG_DEBUG, "WPS: dh_privkey=%x", &wps->dh_privkey);
	if (wps->dev_pw_id != DEV_PW_DEFAULT && wps->dh_privkey &&
		...
		//wpa_printf(MSG_DEBUG, "WPS: Generate new DH keys %x",wps->dh_privkey);
...
FLASH_FUNC atbm_int32 wps_build_req_type(struct wpabuf *msg, enum wps_request_type type)
{
...
FLASH_FUNC atbm_int32 wps_build_resp_type(struct wpabuf *msg, enum wps_response_type type)
{
...
FLASH_FUNC atbm_int32 wps_build_config_methods(struct wpabuf *msg, atbm_uint16 methods)
{
...
*/
FLASH_FUNC atbm_int32 wps_build_uuid_e(struct wpabuf *msg, const atbm_uint8 *uuid)
{
...
FLASH_FUNC atbm_int32 wps_build_dev_password_id(struct wpabuf *msg, atbm_uint16 id)
{
...
FLASH_FUNC atbm_int32 wps_build_config_error(struct wpabuf *msg, atbm_uint16 err)
{
...
FLASH_FUNC atbm_int32 wps_build_authenticator(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC atbm_int32 wps_build_version(struct wpabuf *msg)
{
	/*
...
FLASH_FUNC atbm_int32 wps_build_wfa_ext(struct wpabuf *msg, atbm_int32 req_to_enroll,
...
FLASH_FUNC atbm_int32 wps_build_msg_type(struct wpabuf *msg, enum wps_msg_type msg_type)
{
...
FLASH_FUNC atbm_int32 wps_build_enrollee_nonce(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC atbm_int32 wps_build_registrar_nonce(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC atbm_int32 wps_build_auth_type_flags(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC atbm_int32 wps_build_encr_type_flags(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC atbm_int32 wps_build_conn_type_flags(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC atbm_int32 wps_build_assoc_state(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC atbm_int32 wps_build_key_wrap_auth(struct wps_data *wps, struct wpabuf *msg)
{
	atbm_uint8 hash[SHA256_MAC_LEN];
...
FLASH_FUNC atbm_int32 wps_build_encr_settings(struct wps_data *wps, struct wpabuf *msg,
			    struct wpabuf *plain)
{
	size_t pad_len;
...
FLASH_FUNC struct wpabuf * wps_ie_encapsulate(struct wpabuf *data)
{
	struct wpabuf *ie;
...
//FLASH_FUNC int wps_build_mac_addr(struct wpabuf *msg, const atbm_uint8 *addr)
//{
...
FLASH_FUNC atbm_int32 wps_build_rf_bands_attr(struct wpabuf *msg, atbm_uint8 rf_bands)
{
...
FLASH_FUNC atbm_int32 wps_build_ap_channel(struct wpabuf *msg, atbm_uint16 ap_channel)
{
