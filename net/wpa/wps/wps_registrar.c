...
FLASH_FUNC static int wps_set_ie(struct wps_registrar *reg);
FLASH_FUNC static atbm_void wps_registrar_pbc_timeout(void *eloop_ctx, atbm_void *timeout_ctx);
FLASH_FUNC static atbm_void wps_registrar_set_selected_timeout(void *eloop_ctx,
...
#if 0
FLASH_FUNC static atbm_void wps_free_devices(struct wps_registrar_device *dev)
{
...
FLASH_FUNC static struct wps_registrar_device * wps_device_get(struct wps_registrar *reg,
...
FLASH_FUNC static atbm_void wps_device_clone_data(struct wps_device_data *dst,
...
FLASH_FUNC int wps_device_store(struct wps_registrar *reg,
		     struct wps_device_data *dev, const atbm_uint8 *uuid)
{
	...
	if (d == NULL) {
		d = atbm_kzalloc(sizeof(*d), GFP_KERNEL);
		if (d == NULL)
			return -1;
		d->next = reg->devices;
		reg->devices = d;
...
FLASH_FUNC int wps_registrar_pbc_overlap(struct wps_registrar *reg,
...
FLASH_FUNC static int wps_build_wps_state(struct wps_context *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_ap_setup_locked(struct wps_context *wps,
				     struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_selected_registrar(struct wps_registrar *reg,
					struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_sel_reg_dev_password_id(struct wps_registrar *reg,
					     struct wpabuf *msg)
{
...
/*
FLASH_FUNC static int wps_build_sel_pbc_reg_uuid_e(struct wps_registrar *reg,
					struct wpabuf *msg)
{
	atbm_uint16 id = reg->pbc ? DEV_PW_PUSHBUTTON : DEV_PW_DEFAULT;
	if (!reg->sel_reg_union)
...
FLASH_FUNC static atbm_void wps_set_pushbutton(atbm_uint16 *methods, atbm_uint16 conf_methods)
{
...
FLASH_FUNC static int wps_build_sel_reg_config_methods(struct wps_registrar *reg,
					    struct wpabuf *msg)
{
	atbm_uint16 methods;
	if (!reg->sel_reg_union)
...
FLASH_FUNC static int wps_build_probe_config_methods(struct wps_registrar *reg,
					  struct wpabuf *msg)
{
	atbm_uint16 methods;
	/*
...
FLASH_FUNC static int wps_build_config_methods_r(struct wps_registrar *reg,
				      struct wpabuf *msg)
{
 ...
 */
FLASH_FUNC struct wps_registrar *
wps_registrar_init(struct wps_context *wps,struct wps_registrar_config *cfg)
{
	struct wps_registrar *reg = atbm_kzalloc(sizeof(*reg), GFP_KERNEL);
	if (reg == NULL)
		return NULL;
 ...
 */
FLASH_FUNC atbm_void wps_registrar_deinit(struct wps_registrar *reg)
{
	if (reg == NULL)
		return;
...
FLASH_FUNC int wps_registrar_add_pin(struct wps_registrar *reg,const atbm_uint8 *addr)
{
...
#if 0
FLASH_FUNC static atbm_void wps_registrar_remove_pin(struct wps_registrar *reg)
{
...
FLASH_FUNC static atbm_void wps_registrar_stop_pbc(struct wps_registrar *reg)
{
 ...
 */
FLASH_FUNC int wps_registrar_button_pushed(struct wps_registrar *reg,
...
FLASH_FUNC static atbm_void wps_registrar_pbc_completed(struct wps_registrar *reg)
{
...
FLASH_FUNC static atbm_void wps_registrar_pin_completed(struct wps_registrar *reg)
{
...
FLASH_FUNC atbm_void wps_registrar_complete(struct wps_registrar *registrar, const atbm_uint8 *uuid_e,
...
FLASH_FUNC int wps_registrar_wps_cancel(struct wps_registrar *reg)
{
	if (reg->pbc) {
...
#if 0
FLASH_FUNC static atbm_void wps_cb_pin_needed(struct wps_registrar *reg, const atbm_uint8 *uuid_e,
			      const struct wps_device_data *dev)
{
...
FLASH_FUNC static atbm_void wps_cb_reg_success(struct wps_registrar *reg, const atbm_uint8 *mac_addr,
			       const atbm_uint8 *uuid_e, const atbm_uint8 *dev_pw,
			       atbm_size_t dev_pw_len)
{
...
FLASH_FUNC static atbm_void wps_cb_set_sel_reg(struct wps_registrar *reg)
{
...
FLASH_FUNC static int wps_build_uuid_r(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_r_hash(struct wps_data *wps, struct wpabuf *msg)
{
	atbm_uint8 *hash;
...
FLASH_FUNC static int wps_build_r_snonce1(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_cred_network_idx(struct wpabuf *msg,
...
FLASH_FUNC static int wps_build_cred_ssid(struct wpabuf *msg,
			       const struct wps_credential *cred)
{
...
FLASH_FUNC static int wps_build_r_snonce2(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_cred_auth_type(struct wpabuf *msg,
				    const struct wps_credential *cred)
{
...
FLASH_FUNC static int wps_build_cred_encr_type(struct wpabuf *msg,
				    const struct wps_credential *cred)
{
...
FLASH_FUNC static int wps_build_cred_network_key(struct wpabuf *msg,
				      const struct wps_credential *cred)
{
...
FLASH_FUNC static int wps_build_cred_mac_addr(struct wpabuf *msg,
				   const struct wps_credential *cred)
{
...
FLASH_FUNC static int wps_build_credential(struct wpabuf *msg,
				const struct wps_credential *cred)
{
...
FLASH_FUNC int wps_build_cred(struct wps_data *wps, struct wpabuf *msg)
{
	struct wpabuf *cred;
...
FLASH_FUNC static int wps_build_ap_settings(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static struct wpabuf * wps_build_ap_cred(struct wps_data *wps)
{
...
FLASH_FUNC static struct wpabuf * wps_build_m2(struct wps_data *wps)
{
	struct wpabuf *msg;
...
FLASH_FUNC static struct wpabuf * wps_build_m2d(struct wps_data *wps)
{
	struct wpabuf *msg;
...
FLASH_FUNC static struct wpabuf * wps_build_m4(struct wps_data *wps)
{
	struct wpabuf *msg, *plain;
...
FLASH_FUNC static struct wpabuf * wps_build_m6(struct wps_data *wps)
{
	struct wpabuf *msg, *plain;
...
FLASH_FUNC static struct wpabuf * wps_build_m8(struct wps_data *wps)
{
	struct wpabuf *msg, *plain;
...
FLASH_FUNC struct wpabuf * wps_registrar_get_msg(struct wps_data *wps,
...
FLASH_FUNC static int wps_process_enrollee_nonce(struct wps_data *wps, const atbm_uint8 *e_nonce)
{
	if (e_nonce == NULL) {
...
FLASH_FUNC static int wps_process_registrar_nonce(struct wps_data *wps, const atbm_uint8 *r_nonce)
{
	if (r_nonce == NULL) {
...
FLASH_FUNC static int wps_process_uuid_e(struct wps_data *wps, const atbm_uint8 *uuid_e)
{
	if (uuid_e == NULL) {
...
FLASH_FUNC static int wps_process_dev_password_id(struct wps_data *wps, const atbm_uint8 *pw_id)
{
	if (pw_id == NULL) {
...
FLASH_FUNC static int wps_process_e_hash1(struct wps_data *wps, const atbm_uint8 *e_hash1)
{
	if (e_hash1 == NULL) {
...
FLASH_FUNC static int wps_process_e_hash2(struct wps_data *wps, const atbm_uint8 *e_hash2)
{
	if (e_hash2 == NULL) {
...
FLASH_FUNC static int wps_process_e_snonce1(struct wps_data *wps, const atbm_uint8 *e_snonce1)
{
...
FLASH_FUNC static int wps_process_e_snonce2(struct wps_data *wps, const atbm_uint8 *e_snonce2)
{
	atbm_uint8 hash[SHA256_MAC_LEN];
	const atbm_uint8 *addr[4];
	atbm_size_t len[4];
...
FLASH_FUNC static int wps_process_mac_addr(struct wps_data *wps, const atbm_uint8 *mac_addr)
{
	if (mac_addr == NULL) {
...
FLASH_FUNC static int wps_process_pubkey(struct wps_data *wps, const atbm_uint8 *pk,
			      atbm_size_t pk_len)
{
	if (pk == NULL || pk_len == 0) {
...
FLASH_FUNC static int wps_process_auth_type_flags(struct wps_data *wps, const atbm_uint8 *auth)
{
...
FLASH_FUNC static int wps_process_encr_type_flags(struct wps_data *wps, const atbm_uint8 *encr)
{
...
FLASH_FUNC static int wps_process_conn_type_flags(struct wps_data *wps, const atbm_uint8 *conn)
{
	if (conn == NULL) {
...
FLASH_FUNC static int wps_process_config_methods(struct wps_data *wps, const atbm_uint8 *methods)
{
	atbm_uint16 m;
...
FLASH_FUNC static int wps_process_wps_state(struct wps_data *wps, const atbm_uint8 *state)
{
	if (state == NULL) {
...
FLASH_FUNC static int wps_process_assoc_state(struct wps_data *wps, const atbm_uint8 *assoc)
{
	//atbm_uint16 a;
...
FLASH_FUNC static int wps_process_config_error(struct wps_data *wps, const atbm_uint8 *err)
{
	//atbm_uint16 e;
...
#if 0
FLASH_FUNC static int wps_registrar_p2p_dev_addr_match(struct wps_data *wps)
{
#ifdef CONFIG_P2P
...
FLASH_FUNC static int wps_registrar_skip_overlap(struct wps_data *wps)
{
#ifdef CONFIG_P2P
	struct wps_registrar *reg = wps->wps->registrar;
...
FLASH_FUNC static enum wps_process_res wps_process_m1(struct wps_data *wps,
...
FLASH_FUNC static enum wps_process_res wps_process_m3(struct wps_data *wps,
...
FLASH_FUNC static enum wps_process_res wps_process_m5(struct wps_data *wps,
					   const struct wpabuf *msg,
					   struct wps_parse_attr *attr)
{
...
FLASH_FUNC static atbm_void wps_sta_cred_cb(struct wps_data *wps)
{
	/*
...
FLASH_FUNC static atbm_void wps_cred_update(struct wps_credential *dst,
...
FLASH_FUNC static int wps_process_ap_settings_r(struct wps_data *wps,
				     struct wps_parse_attr *attr)
{
	struct wpabuf *msg;
...
FLASH_FUNC static enum wps_process_res wps_process_m7(struct wps_data *wps,
					   const struct wpabuf *msg,
					   struct wps_parse_attr *attr)
{
	struct wpabuf *decrypted;
...
FLASH_FUNC static enum wps_process_res wps_process_wsc_msg(struct wps_data *wps,
						const struct wpabuf *msg)
{
	struct wps_parse_attr *attr;
...
FLASH_FUNC static enum wps_process_res wps_process_wsc_ack(struct wps_data *wps,
						const struct wpabuf *msg)
{
	struct wps_parse_attr *attr;
...
FLASH_FUNC static enum wps_process_res wps_process_wsc_nack(struct wps_data *wps,
						 const struct wpabuf *msg)
{
	struct wps_parse_attr *attr;
	int old_state;
...
FLASH_FUNC static enum wps_process_res wps_process_wsc_done(struct wps_data *wps,
						 const struct wpabuf *msg)
{
	struct wps_parse_attr *attr;
...
FLASH_FUNC enum wps_process_res wps_registrar_process_msg(struct wps_data *wps,
					       enum wsc_op_code op_code,
					       const struct wpabuf *msg)
{
...
FLASH_FUNC int wps_registrar_update_ie(struct wps_registrar *reg)
{
...
FLASH_FUNC static atbm_void wps_registrar_sel_reg_union(struct wps_registrar *reg)
{
 ...
 */
FLASH_FUNC atbm_void wps_registrar_selected_registrar_changed(struct wps_registrar *reg, atbm_uint16 dev_pw_id)
{
...
#if 0
FLASH_FUNC int wps_registrar_get_info(struct wps_registrar *reg, const atbm_uint8 *addr,
...
FLASH_FUNC int wps_registrar_config_ap(struct wps_registrar *reg,
			    struct wps_credential *cred)
{
#ifdef CONFIG_WPS2
