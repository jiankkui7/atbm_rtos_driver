...
FLASH_FUNC enum atbm_hostapd_hw_mode ieee80211_freq_to_chan(atbm_int32 freq, atbm_uint8 *channel)
{
...
FLASH_FUNC static atbm_int32 country_match(const char *cc[], const char *country)
{
	atbm_int32 i;
...
FLASH_FUNC static atbm_int32 ieee80211_chan_to_freq_us(atbm_uint8 op_class, atbm_uint8 chan)
{
	switch (op_class) {
...
FLASH_FUNC static atbm_int32 ieee80211_chan_to_freq_eu(atbm_uint8 op_class, atbm_uint8 chan)
{
	switch (op_class) {
...
FLASH_FUNC static atbm_int32 ieee80211_chan_to_freq_jp(atbm_uint8 op_class, atbm_uint8 chan)
{
	switch (op_class) {
...
FLASH_FUNC static atbm_int32 ieee80211_chan_to_freq_cn(atbm_uint8 op_class, atbm_uint8 chan)
{
	switch (op_class) {
...
FLASH_FUNC static atbm_int32 ieee80211_chan_to_freq_global(atbm_uint8 op_class, atbm_uint8 chan)
{
 ...
 */
FLASH_FUNC atbm_int32 ieee80211_chan_to_freq(const char *country, atbm_uint8 op_class, atbm_uint8 chan)
{
	atbm_int32 freq;
...
FLASH_FUNC atbm_int32 ieee80211_is_dfs(atbm_int32 freq)
{
...
FLASH_FUNC atbm_int32 is_11b(atbm_uint8 rate)
{
