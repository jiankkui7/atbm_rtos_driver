...
FLASH_FUNC static atbm_int32 wps_set_vendor_ext_wfa_subelem(struct wps_parse_attr *attr,
...
FLASH_FUNC static atbm_int32 wps_parse_vendor_ext_wfa(struct wps_parse_attr *attr, const atbm_uint8 *pos,
				    atbm_uint16 len)
{
...
FLASH_FUNC static atbm_int32 wps_parse_vendor_ext(struct wps_parse_attr *attr, const atbm_uint8 *pos,
				atbm_uint16 len)
{
#if 1
...
FLASH_FUNC atbm_int32 wps_set_attr(struct wps_parse_attr *attr, atbm_uint16 type,
...
FLASH_FUNC atbm_int32 wps_parse_msg(const struct wpabuf *msg, struct wps_parse_attr *attr)
{
