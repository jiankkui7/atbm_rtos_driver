...
FLASH_FUNC static int wps_validate_version(const atbm_uint8 *version, int mandatory)
{
	if (version == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_version2(const atbm_uint8 *version2, int mandatory)
{
	if (version2 == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_request_type(const atbm_uint8 *request_type, int mandatory)
{
...
FLASH_FUNC static int wps_validate_response_type(const atbm_uint8 *response_type, int mandatory)
{
...
FLASH_FUNC static int valid_config_methods(atbm_uint16 val, int wps2)
{
	if (wps2) {
...
FLASH_FUNC static int wps_validate_config_methods(const atbm_uint8 *config_methods, int wps2,
				       int mandatory)
{
	atbm_uint16 val;
...
FLASH_FUNC static int wps_validate_ap_config_methods(const atbm_uint8 *config_methods, int wps2,
					  int mandatory)
{
	atbm_uint16 val;
...
FLASH_FUNC static int wps_validate_uuid_e(const atbm_uint8 *uuid_e, int mandatory)
{
	if (uuid_e == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_uuid_r(const atbm_uint8 *uuid_r, int mandatory)
{
	if (uuid_r == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_primary_dev_type(const atbm_uint8 *primary_dev_type,
					 int mandatory)
{
...
FLASH_FUNC static int wps_validate_rf_bands(const atbm_uint8 *rf_bands, int mandatory)
{
	if (rf_bands == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_assoc_state(const atbm_uint8 *assoc_state, int mandatory)
{
	atbm_uint16 val;
	if (assoc_state == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_config_error(const atbm_uint8 *config_error, int mandatory)
{
	atbm_uint16 val;
...
FLASH_FUNC static int wps_validate_dev_password_id(const atbm_uint8 *dev_password_id,
					int mandatory)
{
	atbm_uint16 val;
...
FLASH_FUNC static int wps_validate_manufacturer(const atbm_uint8 *manufacturer, atbm_size_t len,
				     int mandatory)
{
...
FLASH_FUNC static int wps_validate_model_name(const atbm_uint8 *model_name, atbm_size_t len,
				   int mandatory)
{
	if (model_name == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_model_number(const atbm_uint8 *model_number, atbm_size_t len,
				     int mandatory)
{
...
FLASH_FUNC static int wps_validate_serial_number(const atbm_uint8 *serial_number, atbm_size_t len,
				      int mandatory)
{
...
FLASH_FUNC static int wps_validate_dev_name(const atbm_uint8 *dev_name, atbm_size_t len,
				 int mandatory)
{
	if (dev_name == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_request_to_enroll(const atbm_uint8 *request_to_enroll,
					  int mandatory)
{
...
FLASH_FUNC static int wps_validate_req_dev_type(const atbm_uint8 *req_dev_type[], atbm_size_t num,
				     int mandatory)
{
	if (num == 0) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_wps_state(const atbm_uint8 *wps_state, int mandatory)
{
	if (wps_state == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_ap_setup_locked(const atbm_uint8 *ap_setup_locked,
					int mandatory)
{
...
FLASH_FUNC static int wps_validate_selected_registrar(const atbm_uint8 *selected_registrar,
					   int mandatory)
{
...
FLASH_FUNC static int wps_validate_sel_reg_config_methods(const atbm_uint8 *config_methods,
...
FLASH_FUNC static int wps_validate_authorized_macs(const atbm_uint8 *authorized_macs, atbm_size_t len,
					int mandatory)
{
...
FLASH_FUNC static int wps_validate_msg_type(const atbm_uint8 *msg_type, int mandatory)
{
	if (msg_type == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_mac_addr(const atbm_uint8 *mac_addr, int mandatory)
{
	if (mac_addr == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_enrollee_nonce(const atbm_uint8 *enrollee_nonce, int mandatory)
{
...
FLASH_FUNC static int wps_validate_registrar_nonce(const atbm_uint8 *registrar_nonce,
					int mandatory)
{
...
FLASH_FUNC static int wps_validate_public_key(const atbm_uint8 *public_key, atbm_size_t len,
				   int mandatory)
{
	if (public_key == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int num_bits_set(atbm_uint16 val)
{
	int c;
	for (c = 0; val; c++)
		val &= val - 1;
...
FLASH_FUNC static int wps_validate_auth_type_flags(const atbm_uint8 *flags, int mandatory)
{
	atbm_uint16 val;
...
FLASH_FUNC static int wps_validate_auth_type(const atbm_uint8 *type, int mandatory)
{
	atbm_uint16 val;
...
FLASH_FUNC static int wps_validate_encr_type_flags(const atbm_uint8 *flags, int mandatory)
{
	atbm_uint16 val;
...
FLASH_FUNC static int wps_validate_encr_type(const atbm_uint8 *type, int mandatory)
{
	atbm_uint16 val;
...
FLASH_FUNC static int wps_validate_conn_type_flags(const atbm_uint8 *flags, int mandatory)
{
	if (flags == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_os_version(const atbm_uint8 *os_version, int mandatory)
{
	if (os_version == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_authenticator(const atbm_uint8 *authenticator, int mandatory)
{
...
FLASH_FUNC static int wps_validate_e_hash1(const atbm_uint8 *hash, int mandatory)
{
	if (hash == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_e_hash2(const atbm_uint8 *hash, int mandatory)
{
	if (hash == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_r_hash1(const atbm_uint8 *hash, int mandatory)
{
	if (hash == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_r_hash2(const atbm_uint8 *hash, int mandatory)
{
	if (hash == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_encr_settings(const atbm_uint8 *encr_settings, atbm_size_t len,
				   int mandatory)
{
...
FLASH_FUNC static int wps_validate_settings_delay_time(const atbm_uint8 *delay, int mandatory)
{
	if (delay == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_r_snonce1(const atbm_uint8 *nonce, int mandatory)
{
	if (nonce == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_r_snonce2(const atbm_uint8 *nonce, int mandatory)
{
	if (nonce == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_e_snonce1(const atbm_uint8 *nonce, int mandatory)
{
	if (nonce == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_e_snonce2(const atbm_uint8 *nonce, int mandatory)
{
	if (nonce == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_key_wrap_auth(const atbm_uint8 *auth, int mandatory)
{
	if (auth == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_ssid(const atbm_uint8 *ssid, atbm_size_t ssid_len, int mandatory)
{
	if (ssid == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_network_key_index(const atbm_uint8 *idx, int mandatory)
{
	if (idx == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_network_idx(const atbm_uint8 *idx, int mandatory)
{
	if (idx == NULL) {
		if (mandatory) {
...
FLASH_FUNC static int wps_validate_network_key(const atbm_uint8 *key, atbm_size_t key_len,
...
FLASH_FUNC static int wps_validate_network_key_shareable(const atbm_uint8 *val, int mandatory)
{
	if (val == NULL) {
		if (mandatory) {
			wpa_printf(MSG_ERROR, "WPS-STRICT: Network Key "
...
FLASH_FUNC static int wps_validate_cred(const atbm_uint8 *cred, atbm_size_t len)
{
	int ret = 0;
...
FLASH_FUNC static int wps_validate_credential(const atbm_uint8 *cred[], atbm_size_t len[], atbm_size_t num,
				   int mandatory)
{
	size_t i;
...
FLASH_FUNC int wps_validate_beacon(const struct wpabuf *wps_ie)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2, sel_reg;
...
FLASH_FUNC int wps_validate_beacon_probe_resp(const struct wpabuf *wps_ie, int probe,
...
FLASH_FUNC int wps_validate_probe_req(const struct wpabuf *wps_ie, const atbm_uint8 *addr)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_assoc_req(const struct wpabuf *wps_ie)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_assoc_resp(const struct wpabuf *wps_ie)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m1(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m2(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m2d(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m3(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m4(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m4_encr(const struct wpabuf *tlvs, int wps2)
{
	int ret = 0;
	struct wps_parse_attr *attr;
...
FLASH_FUNC int wps_validate_m5(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m5_encr(const struct wpabuf *tlvs, int wps2)
{
	int ret = 0;
	struct wps_parse_attr *attr;
...
FLASH_FUNC int wps_validate_m6(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m6_encr(const struct wpabuf *tlvs, int wps2)
{
	int ret = 0;
	struct wps_parse_attr *attr;
...
FLASH_FUNC int wps_validate_m7(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m7_encr(const struct wpabuf *tlvs, int ap, int wps2)
{
	int ret = 0;
	struct wps_parse_attr *attr;
...
FLASH_FUNC int wps_validate_m8(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_m8_encr(const struct wpabuf *tlvs, int ap, int wps2)
{
	int ret = 0;
	struct wps_parse_attr *attr;
...
FLASH_FUNC int wps_validate_wsc_ack(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_wsc_nack(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_wsc_done(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
...
FLASH_FUNC int wps_validate_upnp_set_selected_registrar(const struct wpabuf *tlvs)
{
	int ret = 0;
	struct wps_parse_attr *attr;
	int wps2;
