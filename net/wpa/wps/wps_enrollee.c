...
FLASH_FUNC static int wps_build_mac_addr(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_wps_state(struct wps_data *wps, struct wpabuf *msg)
{
	atbm_uint8 state;
	if (wps->wps->ap)
...
FLASH_FUNC static int wps_build_e_hash(struct wps_data *wps, struct wpabuf *msg)
{
	atbm_uint8 *hash;
...
FLASH_FUNC static int wps_build_e_snonce1(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_e_snonce2(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static struct wpabuf * wps_build_m1(struct wps_data *wps)
{
	struct wpabuf *msg;
...
FLASH_FUNC static struct wpabuf * wps_build_m3(struct wps_data *wps)
{
	struct wpabuf *msg;
...
FLASH_FUNC static struct wpabuf * wps_build_m5(struct wps_data *wps)
{
...
FLASH_FUNC static int wps_build_cred_ssid(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_cred_auth_type(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_cred_encr_type(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_cred_network_key(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_cred_mac_addr(struct wps_data *wps, struct wpabuf *msg)
{
...
FLASH_FUNC static int wps_build_ap_settings(struct wps_data *wps, struct wpabuf *plain)
{
...
FLASH_FUNC static struct wpabuf * wps_build_m7(struct wps_data *wps)
{
	struct wpabuf *msg, *plain;
...
FLASH_FUNC static struct wpabuf * wps_build_wsc_done(struct wps_data *wps)
{
	struct wpabuf *msg;
...
FLASH_FUNC struct wpabuf * wps_enrollee_get_msg(struct wps_data *wps,
...
FLASH_FUNC static int wps_process_uuid_r(struct wps_data *wps, const atbm_uint8 *uuid_r)
{
	if (uuid_r == NULL) {
...
FLASH_FUNC static int wps_process_r_hash1(struct wps_data *wps, const atbm_uint8 *r_hash1)
{
	if (r_hash1 == NULL) {
...
FLASH_FUNC static int wps_process_r_hash2(struct wps_data *wps, const atbm_uint8 *r_hash2)
{
	if (r_hash2 == NULL) {
...
FLASH_FUNC static int wps_process_r_snonce1(struct wps_data *wps, const atbm_uint8 *r_snonce1)
{
...
FLASH_FUNC static int wps_process_r_snonce2(struct wps_data *wps, const atbm_uint8 *r_snonce2)
{
	atbm_uint8 hash[SHA256_MAC_LEN];
	const atbm_uint8 *addr[4];
	atbm_size_t len[4];
...
FLASH_FUNC static int wps_process_cred_e(struct wps_data *wps, const atbm_uint8 *cred,
			      atbm_size_t cred_len, int wps2)
{
	...
	attr = atbm_kzalloc(sizeof(*attr), GFP_KERNEL);
	if(attr == NULL){
...
FLASH_FUNC static int wps_process_creds(struct wps_data *wps, const atbm_uint8 *cred[],
...
#if 0
FLASH_FUNC static int wps_process_ap_settings_e(struct wps_data *wps,
				     struct wps_parse_attr *attr,
...
FLASH_FUNC static enum wps_process_res wps_process_m2(struct wps_data *wps,
...
FLASH_FUNC static enum wps_process_res wps_process_m2d(struct wps_data *wps,
					    struct wps_parse_attr *attr)
{
...
FLASH_FUNC static enum wps_process_res wps_process_m4(struct wps_data *wps,
					   const struct wpabuf *msg,
					   struct wps_parse_attr *attr)
{
	...
	eattr = atbm_kzalloc(sizeof(*eattr), GFP_KERNEL);
	if(eattr == NULL){
...
FLASH_FUNC static enum wps_process_res wps_process_m6(struct wps_data *wps,
					   const struct wpabuf *msg,
					   struct wps_parse_attr *attr)
{
	enum wps_process_res ret = WPS_CONTINUE;
...
FLASH_FUNC static enum wps_process_res wps_process_m8(struct wps_data *wps,const struct wpabuf *msg,struct wps_parse_attr *attr)
{
	enum wps_process_res ret = WPS_CONTINUE;
	struct wpabuf *decrypted;
	struct wps_parse_attr *eattr;
...
FLASH_FUNC atbm_void wps_process_m8_task(void *data)
{
	enum wps_process_res ret = WPS_CONTINUE;
...
FLASH_FUNC static enum wps_process_res wps_process_m8_preHandle(struct wps_data *wps, const struct wpabuf *msg, struct wps_parse_attr *attr)
{
	enum wps_process_res ret = WPS_CONTINUE;
	...
	proc_msg = atbm_kzalloc(sizeof(*proc_msg), GFP_KERNEL);
	if(proc_msg == NULL){
	...
	proc_msg->attr = atbm_kzalloc(sizeof(*proc_msg->attr), GFP_KERNEL);
...
#else
FLASH_FUNC static enum wps_process_res wps_process_m8(struct wps_data *wps,
					   const struct wpabuf *msg,
					   struct wps_parse_attr *attr)
{
	enum wps_process_res ret = WPS_CONTINUE;
						...
						const struct wpabuf *msg)
{
	...
	//wifi_printk(WIFI_WPS, "Free Stack 5: %d\n", atbm_getThreadStackFreesize());
...
FLASH_FUNC enum wps_process_res wps_enrollee_process_msg(struct wps_data *wps,
					      enum wsc_op_code op_code,
					      const struct wpabuf *msg)
{
