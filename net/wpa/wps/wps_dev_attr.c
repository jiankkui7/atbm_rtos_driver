...
FLASH_FUNC int wps_build_manufacturer(struct wps_device_data *dev, struct wpabuf *msg)
{
	size_t len;
...
FLASH_FUNC int wps_build_model_name(struct wps_device_data *dev, struct wpabuf *msg)
{
	size_t len;
...
FLASH_FUNC int wps_build_model_number(struct wps_device_data *dev, struct wpabuf *msg)
{
	size_t len;
...
FLASH_FUNC int wps_build_serial_number(struct wps_device_data *dev, struct wpabuf *msg)
{
	size_t len;
...
FLASH_FUNC int wps_build_primary_dev_type(struct wps_device_data *dev, struct wpabuf *msg)
{
...
FLASH_FUNC int wps_build_secondary_dev_type(struct wps_device_data *dev,
				  struct wpabuf *msg)
{
...
FLASH_FUNC int wps_build_req_dev_type(struct wps_device_data *dev, struct wpabuf *msg,
...
FLASH_FUNC int wps_build_dev_name(struct wps_device_data *dev, struct wpabuf *msg)
{
	size_t len;
...
FLASH_FUNC int wps_build_device_attrs(struct wps_device_data *dev, struct wpabuf *msg)
{
...
FLASH_FUNC int wps_build_os_version(struct wps_device_data *dev, struct wpabuf *msg)
{
...
FLASH_FUNC int wps_build_vendor_ext_m1(struct wps_device_data *dev, struct wpabuf *msg)
{
...
FLASH_FUNC int wps_build_rf_bands(struct wps_device_data *dev, struct wpabuf *msg)
{
	return wps_build_rf_bands_attr(msg, dev->rf_bands);
}


FLASH_FUNC int wps_build_vendor_ext(struct wps_device_data *dev, struct wpabuf *msg)
{
	int i;
...
FLASH_FUNC static int wps_process_manufacturer(struct wps_device_data *dev, const atbm_uint8 *str,
				    atbm_size_t str_len)
{
	if (str == NULL) {
...
FLASH_FUNC static int wps_process_model_name(struct wps_device_data *dev, const atbm_uint8 *str,
				  atbm_size_t str_len)
{
	if (str == NULL) {
...
FLASH_FUNC static int wps_process_model_number(struct wps_device_data *dev, const atbm_uint8 *str,
				    atbm_size_t str_len)
{
	if (str == NULL) {
...
FLASH_FUNC static int wps_process_serial_number(struct wps_device_data *dev,
...
FLASH_FUNC static int wps_process_dev_name(struct wps_device_data *dev, const atbm_uint8 *str,
				size_t str_len)
{
	if (str == NULL) {
...
FLASH_FUNC static int wps_process_primary_dev_type(struct wps_device_data *dev,
...
FLASH_FUNC int wps_process_device_attrs(struct wps_device_data *dev,
...
FLASH_FUNC int wps_process_os_version(struct wps_device_data *dev, const atbm_uint8 *ver)
{
	if (ver == NULL) {
...
FLASH_FUNC int wps_process_rf_bands(struct wps_device_data *dev, const atbm_uint8 *bands)
{
	if (bands == NULL) {
...
FLASH_FUNC atbm_void wps_device_data_dup(struct wps_device_data *dst,
...
FLASH_FUNC atbm_void wps_device_data_free(struct wps_device_data *dev)
{
	if(dev->device_name)
		atbm_kfree(dev->device_name);
