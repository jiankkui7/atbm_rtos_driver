...
FLASH_FUNC static inline int os_snprintf_error(size_t size, int res)
{
	return res < 0 || (atbm_uint32) res >= size;
}


FLASH_FUNC static inline int _wpa_snprintf_hex(char *buf, atbm_size_t buf_size, const atbm_uint8 *data,
 ...
 */
FLASH_FUNC int wpa_snprintf_hex(char *buf, atbm_size_t buf_size, const atbm_uint8 *data, atbm_size_t len)
{
 ...
 */
FLASH_FUNC atbm_int32 eap_hdr_len_valid(const struct wpabuf *msg, atbm_size_t min_payload)
{
 ...
 * not.
 */
FLASH_FUNC const atbm_uint8 * eap_hdr_validate(int vendor, EapType eap_type,
 ...
 */
FLASH_FUNC struct wpabuf * eap_msg_alloc(int vendor, EapType type, atbm_size_t payload_len,
 ...
 */
FLASH_FUNC atbm_void eap_update_len(struct wpabuf *msg)
{
	struct atbm_eap_hdr *hdr;
 ...
 */
FLASH_FUNC atbm_uint8 eap_get_id(const struct wpabuf *msg)
{
 ...
 */
FLASH_FUNC EapType eap_get_type(const struct wpabuf *msg)
{
...
FLASH_FUNC static atbm_void eap_identity_process(struct hostapd_data *hapd,struct hostapd_sta_info *sta, struct wpabuf *respData)
{
...
FLASH_FUNC static atbm_void handle_eap_response(struct hostapd_data *hapd,
...
FLASH_FUNC atbm_void handle_eap(struct hostapd_data *hapd, struct hostapd_sta_info *sta,
