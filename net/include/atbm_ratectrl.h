...
FLASH_FUNC ATBM_BOOL atbmwifi_rate_control_send_low(struct atbmwifi_cfg80211_rate *sta,struct atbm_buff *skb);
int atbmwifi_ieee80211_frame_duration(size_t len,
