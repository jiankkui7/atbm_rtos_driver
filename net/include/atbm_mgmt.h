...
FLASH_FUNC struct atbm_buff * atbmwifi_ieee80211_send_assoc_resp(struct atbmwifi_vif *priv,atbm_uint16 status_code, int reassoc, const atbm_uint8 *ies, atbm_size_t ies_len,atbm_uint16 aid);

FLASH_FUNC struct atbm_buff *atbmwifi_ieee80211_send_proberesp(struct atbmwifi_vif *priv,const atbm_uint8 *ies,atbm_size_t ies_len);
...
FLASH_FUNC struct atbm_buff * atbmwifi_ieee80211_send_auth(struct atbmwifi_vif *priv, atbm_uint16 transaction, atbm_uint16 auth_alg,  const atbm_uint8 *da,const atbm_uint8 *bssid,atbm_uint16 resp);
...
FLASH_FUNC int atbmwifi_tx_data_Null_response(struct atbmwifi_vif *priv,const atbm_uint8 *da,const atbm_uint8 *bssid,int tid,enum atbm_ieee80211_frame_release_type reason);
FLASH_FUNC int atbmwifi_ieee80211_tx_data_QosNullData(struct atbmwifi_vif *priv,const atbm_uint8 *da,const atbm_uint8 *bssid,atbm_uint8 tid);
FLASH_FUNC 	int atbmwifi_set_tim(struct atbmwifi_vif  *priv, atbm_uint16 aid, ATBM_BOOL set);
FLASH_FUNC atbm_uint8 *atbmwifi_add_tim(atbm_uint8 *frm, struct atbmwifi_vif  *priv,atbm_uint8 mcast);
FLASH_FUNC struct atbm_buff * atbmwifi_ieee80211_send_NullData(struct atbmwifi_vif *priv,const atbm_uint8 *da,const atbm_uint8 *bssid);
...
FLASH_FUNC atbm_void atbmwifi_ieee80211_assoc_success(struct atbmwifi_vif *priv,struct atbm_buff *skb);
...
FLASH_FUNC struct atbm_buff * atbmwifi_ieee80211_QosNullData(struct atbmwifi_vif *priv,const atbm_uint8 *da,
